        ...
        <div className='bg-white max-w-6xl mx-auto mt-6 rounded-xl'>
            <div className=' md:flex items-center justify-center gap-6 p-4'>
                <div className='p-4 border-r-2 border-gray-300 text-center'>
                    ...
                    <p className='text-xl font-semibold'>$ 123,452.32</p>
                </div>
                <div className='p-4 border-r-2 border-gray-300 text-center'>
                    <p className='flex items-center gap-3 text-xl  mb-2 text-gray-500'>Wallet Balances <TbReceiptBitcoin /></p>
                    <p className='text-xl '><span className='font-semibold'>22.39483800 </span><span className='text-[10px] bg-gray-300 rounded text-gray-400 px-1'>BTC</span> </p>
                </div>
                <div className='p-4 border-r-2 border-gray-300 flex items-center gap-2 text-center '>
                    ...
                    <p className='text-[10px] bg-gray-300 rounded text-gray-400 px-1'>Taka</p>
                </div>
                <div>
                    <div className='p-2 flex items-center gap-4 text-center '>
                        <div className='flex items-center gap-2 p-2 border-none bg-purple-600 text-white rounded-xl '>
                            <MdFileDownload />
                            <button className='btn text-base cursor-pointer font-semibold'>Deposite</button>
                        </div>
                        <div className='flex items-center gap-2 p-2 border-none text-white bg-purple-600 rounded-xl font-semibold'>
                            <HiUpload />
                            <button className='text-base cursor-pointer font-semibold'>Withdraw</button>
                        </div>
                    </div>
                    <p></p>
                </div>
