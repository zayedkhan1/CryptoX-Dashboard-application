    ...
    return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 ">
        ...
        <div className="bg-white rounded-xl shadow p-4  flex flex-col">
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="flex gap-2">
              <button className="bg-purple-600 text-white px-4 py-1 rounded-full text-sm">Buy</button>
              <button className="bg-purple-600 text-white px-4 py-1 rounded-full text-sm">Sell</button>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow p-4 flex flex-col">
          ...
          <button className="mt-5 bg-gray-200 text-gray-800 p-2 rounded-full">View All</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
        <div className="bg-white rounded-xl shadow p-4 flex flex-col">
          <span className="bg-purple-500 text-white px-2 py-1 rounded-full text-base w-fit mb-4">Loans</span>
